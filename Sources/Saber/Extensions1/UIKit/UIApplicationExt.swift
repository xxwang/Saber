...
public extension UIApplication {
    ...
    ///   - app:系统App枚举
    ///   - completion:完成回调
    static func openSystemApp(_ app: CMSystemApp, completion: @escaping Callbacks.BoolCallback) {
    ...
    ///   - app:第三方app枚举
    ///   - completion:完成回调
    static func openOtherApp(_ app: CMOtherApp, completion: @escaping Callbacks.BoolCallback) {
        openURL(app.url, completion: completion)
    }
    ...
    ///   - completion:完成回调
    static func call(with phoneNumber: String, completion: @escaping Callbacks.BoolCallback) {
        // 判断是否有效
    ...
    ///   - url:要打开的URL地址
    ///   - complete:完成回调
    static func openURL(_ url: URL, completion: @escaping Callbacks.BoolCallback) {
        // iOS 10.0 以前
