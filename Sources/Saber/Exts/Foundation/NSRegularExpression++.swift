...
// MARK: - 方法
public extension SaberExt where Base: NSRegularExpression {
    ...
    func enumerateMatches(
        ...
        base.enumerateMatches(in: string,
                              options: options,
    ...
    func numberOfMatches(
        ...
        return base.numberOfMatches(in: string,
                                    options: options,
                                    range: NSRange(range, in: string))
    }
    ...
    func firstMatch(
        ...
        return base.firstMatch(in: string,
                               options: options,
                               range: NSRange(range, in: string))
    }
    ...
    func rangeOfFirstMatch(
        ...
        return Range(base.rangeOfFirstMatch(in: string,
                                            options: options,
                                            range: NSRange(range, in: string)),
                     in: string)
    }
    ...
    func stringByReplacingMatches(
        ...
        return base.stringByReplacingMatches(in: string,
                                             options: options,
                                             range: NSRange(range, in: string),
                                             withTemplate: templ)
    }
    ...
    func replaceMatches(
        ...
        let matches = base.replaceMatches(in: mutableString,
                                          options: options,
                                          range: NSRange(range, in: string),
                                          withTemplate: templ)
