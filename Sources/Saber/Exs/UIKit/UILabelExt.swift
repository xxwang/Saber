...
public extension UILabel {
    ...
    var fontSize: CGFloat {
        ...
        attributedText.setAttributes([
            .font: font as Any,
        ], range: attributedText.sb.fullNSRange())
...
public extension UILabel {
    ...
    func attributedSize(_ maxWidth: CGFloat = sb1.sc.width) -> CGSize {
        return attributedText?.sb.strSize(maxWidth) ?? .zero
    }
}
...
public extension UILabel {
    ...
    func setupTextSpacing(
        ...
        // 字体
        if let font = font {
            attributedString.addAttribute(.font, value: font, range: attributedString.sb.fullNSRange())
        }
...
public extension UILabel {
    ...
    func linesContent(
        ...
        attributedString.addAttributes(attributesDict, range: attributedString.sb.fullNSRange())
    ...
    func changeLineSpacing(_ lineSpacing: CGFloat) {
        ...
        // 已有属性列表
        if var attributes = attributedText?.sb.attributes() {
            // 已有段落样式
