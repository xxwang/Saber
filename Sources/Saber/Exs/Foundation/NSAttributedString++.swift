...
// MARK: - 方法
public extension SaberEx where Base: NSAttributedString {
    /// `NSAttributedString`上的`属性字典`
    /// - Returns: `[Base.Key: Any]`
    func attributes() -> [Base.Key: Any] {
    ...
    func subNSRange(_ subStr: String) -> NSRange {
        return base.string.sb.subNSRange(subStr)
    }
...
public extension NSAttributedString {
    ...
    /// - Returns:`NSAttributedString`
    @discardableResult
    func setFont(_ font: UIFont, for range: NSRange? = nil) -> NSAttributedString {
    ...
    /// - Returns:`NSAttributedString`
    @discardableResult
    func setForegroundColor(_ color: UIColor, for range: NSRange? = nil) -> NSAttributedString {
        let range = range ?? sb.fullNSRange()
    ...
    func setLineSpacing(
        ...
        var style = sb.attributes()[.paragraphStyle] as? NSMutableParagraphStyle
        if style == nil {
    ...
    func setFirstLineHeadIndent(_ indent: CGFloat) -> NSAttributedString {
        ...
        return setAttributes([NSAttributedString.Key.paragraphStyle: paragraphStyle], for: sb.fullNSRange())
    }
