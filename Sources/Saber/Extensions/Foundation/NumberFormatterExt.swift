...
public extension NumberFormatter {
    ...
    ///   - nstyle: 相应的显示样式
    /// - Returns: 格式化后的字符串
    static func numberFormatting(value: Float, number nstyle: NumberFormatter.Style = .none) -> String {
    ...
    ///   - nstyle: 相应的显示样式
    /// - Returns: 格式化后的字符串
    static func numberFormatting(value: Double, number nstyle: NumberFormatter.Style = .none) -> String {
        // 原始数字(需要先转成NSNumber类型)
        let number = NSNumber(value: value)
        return NumberFormatter.localizedString(from: number, number: nstyle)
    }
    ...
    ///   - nstyle: 相应的显示样式
    /// - Returns: 格式化后的字符串
    static func stringFormattingNumber(value: String, number nstyle: NumberFormatter.Style = .none) -> String? {
        // 从字符串装成数字
    ...
    ///   - nstyle: 显示样式
    /// - Returns: 格式化后的值
    static func setGroupingSeparatorAndSize(value: String, separator: String, groupingSize: Int, number nstyle: NumberFormatter.Style = .none) -> String? {
    ...
    ///   - nstyle: 显示样式
    /// - Returns: 格式化后的值
    static func setFormatWidthPaddingCharacterAndPosition(value: String, formatWidth: Int, paddingCharacter: String, paddingPosition: NumberFormatter.PadPosition = .beforePrefix, number nstyle: NumberFormatter.Style = .none) -> String? {
        // 创建一个NumberFormatter对象
        let numberFormatter = NumberFormatter()
        // 设置number显示样式
        numberFormatter.numberStyle = nstyle
    ...
    ///   - nstyle: 显示样式
    /// - Returns: 格式化后的值
    static func setMaximumIntegerDigitsAndMinimumIntegerDigits(value: String, maximumIntegerDigits: Int, minimumIntegerDigits: Int, number nstyle: NumberFormatter.Style = .none) -> String? {
        // 创建一个NumberFormatter对象
        let numberFormatter = NumberFormatter()
        // 设置number显示样式
        numberFormatter.numberStyle = nstyle
    ...
    ///   - nstyle: 显示样式
    /// - Returns: 格式化后的值
    static func setmMximumFractionDigitsAndMinimumFractionDigits(value: String, maximumFractionDigits: Int, minimumFractionDigits: Int) -> String? {
        // 创建一个NumberFormatter对象
        let numberFormatter = NumberFormatter()
    ...
    ///   - nstyle: 显示样式
    /// - Returns: 格式化后的值
    static func setMaximumIntegerDigitsAndMinimumIntegerDigits(value: String, positivePrefix: String, positiveSuffix: String, number nstyle: NumberFormatter.Style = .none) -> String? {
        // 创建一个NumberFormatter对象
        let numberFormatter = NumberFormatter()
        // 设置number显示样式
        numberFormatter.numberStyle = nstyle
    ...
    ///   - nstyle: 显示样式
    /// - Returns: 格式化后的值
    static func setPositiveFormat(value: String, positiveFormat: String, number nstyle: NumberFormatter.Style = .none) -> String? {
        // 创建一个NumberFormatter对象
        let numberFormatter = NumberFormatter()
        // 设置number显示样式
        numberFormatter.numberStyle = nstyle
